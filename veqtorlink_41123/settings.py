"""
Django settings for veqtorlink_41123 project.
...
ROOT_URLCONF = 'veqtorlink_41123.urls'
...
WSGI_APPLICATION = 'veqtorlink_41123.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "veqtorlink_41123 API",
    "DESCRIPTION": "API documentation for veqtorlink_41123 App",
    "VERSION": "v1",
}
